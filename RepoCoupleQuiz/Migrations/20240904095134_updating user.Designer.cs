...
namespace RepoCoupleQuiz.Migrations
{
    ...
    [Migration("20240904095134_updating user")]
            ...
            modelBuilder.Entity("RepoCoupleQuiz.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GlobalId = new Guid("bdfdc0f3-6f68-4560-8f56-e9eec2d8e773"),
                            Active = false,
                        ...
                        new
                        {
                            GlobalId = new Guid("21d4ab18-1b81-4821-bf71-05e504479694"),
                            Active = false,
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeletedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RoleName = "User",
            ...
            modelBuilder.Entity("RepoCoupleQuiz.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GlobalId = new Guid("31db4341-068d-481d-a7c1-40df5455fde1"),
                            Active = true,
                            Age = 23,
                            CreatedAt = new DateTime(2024, 9, 4, 9, 51, 33, 677, DateTimeKind.Utc).AddTicks(372),
                            DeletedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            GlobalId = new Guid("fefe2187-18f7-4227-b278-2160c47d4388"),
                            Active = true,
                            Age = 23,
                            CreatedAt = new DateTime(2024, 9, 4, 9, 51, 33, 677, DateTimeKind.Utc).AddTicks(375),
                            DeletedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("RepoCoupleQuiz.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GlobalId = new Guid("cbf00248-6385-4174-a7cb-39a6179a1208"),
                            Active = false,
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeletedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RoleId = new Guid("bdfdc0f3-6f68-4560-8f56-e9eec2d8e773"),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserId = new Guid("31db4341-068d-481d-a7c1-40df5455fde1")
                        },
                        new
                        {
                            GlobalId = new Guid("a55adaa6-2d20-4a0a-a540-10bf5e22b465"),
                            Active = false,
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DeletedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RoleId = new Guid("21d4ab18-1b81-4821-bf71-05e504479694"),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserId = new Guid("fefe2187-18f7-4227-b278-2160c47d4388")
                        });
                });
